var store = [{
        ...
        "excerpt":"Setup notes Some notes from setting up the SwissBIAS website on GitHub, using Jekyll, from Ubuntu First steps (hello world and README) Following instructions on https://pages.github.com/ Editing files/repo locally and using a terminal as git client, do $ git add --all $ git commit -m \"Initial commit\" $ git push...","categories": ["technotes"],
